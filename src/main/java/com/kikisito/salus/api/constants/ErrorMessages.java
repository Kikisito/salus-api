...
public final class ErrorMessages {
    ...
    public static final String MEDICAL_CENTER_NOT_FOUND = "Centro médico no encontrado";
    public static final String ROOM_NOT_FOUND = "Consulta no encontrada";
    ...
    public static final String DOCTOR_NOT_FOUND = "Médico no encontrado";
    public static final String SPECIALTY_NOT_FOUND = "Especialidad no encontrada";
    public static final String DOCTOR_ALREADY_HAS_SPECIALTY = "El médico ya tiene asignada la especialidad";
    public static final String END_TIME_MUST_BE_AFTER_START_TIME = "End time must be after start time";
    public static final String SCHEDULE_CONFLICT = "El horario colapsa con otro horario existente";
    public static final String SCHEDULE_NOT_FOUND = "Agenda no encontrada";
    public static final String APPOINTMENT_SLOT_NOT_FOUND = "Cita slot no encontrada";
